...
export function registerPayment(program) {
    ...
    payment
        ...
        }, config.outputMode, "Payment create request completed. Use --json to view the full response and curl example.");
    });
    ...
    instrument
        ...
        }, config.outputMode, "Payment instrument create request completed. Use --json to view the full response and curl example.");
    });
}
